...
//      mWebView.setScrollbarFadingEnabled(true);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://www.google.com/search?q=weather+frankfurt");
        } else {
...
//        showVersionInfo();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_1) {
            ...
            mWebView.getSettings().setJavaScriptEnabled(true); //for wa web
            mWebView.loadUrl("https://www.google.com/search?q=weather+heidelberg");
        } else if (id == R.id.menu_3) {
            mWebView.getSettings().setJavaScriptEnabled(true); //for wa web
            mWebView.loadUrl("https://wtfismyip.com/");
        } else if (id == R.id.menu_4) {
            mWebView.getSettings().setJavaScriptEnabled(true); //for wa web
            mWebView.loadUrl("https://www.google.com/");
        } else if (id == R.id.menu_5) {
            mWebView.getSettings().setJavaScriptEnabled(true); //for wa web
            mWebView.loadUrl("https://calendar.google.com");
        } else if (id == R.id.menu_6) {
            mWebView.getSettings().setJavaScriptEnabled(true); //for wa web
            mWebView.loadUrl("https://photos.google.com/search/_tra_");
